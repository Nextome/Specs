...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local//NextomeMap/2.0.23/Release/NextomeMap_Release/NextomeMap_Release.zip' }
...
s.dependency 'FlutterPluginRegistrant_Release', '2.0.23' 
