...
TrentinoTrasportiSdk
  ...
  s.source           = { :http => 'https://packages.nextome.dev/artifactory/smart-ticketing-cocoapods-local/TrentinoTrasportiSdk/5.1.0-beta11/TrentinoTrasportiSdk.zip' }
