#
    ...
    s.source           = { :http => 'https://packages.nextome.dev/artifactory/smart-ticketing-cocoapods-local/TrentinoTrasportiSdk/6.0.0-beta05/TrentinoTrasportiSdk.zip' }
