...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local//NextomeMap/2.1.5/Profile/NextomeMap_Profile/NextomeMap_Profile.zip' }
...
s.dependency 'FlutterPluginRegistrant_Profile', '2.1.5' 

s.dependency 'Flutter_Profile', '3.35.700'
