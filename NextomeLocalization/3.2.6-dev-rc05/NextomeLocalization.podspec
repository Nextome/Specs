Pod::Spec.new do |spec|
    ...
    spec.version                  = '3.2.6-dev-rc05'
    spec.homepage                 = 'https://docs.nextome.dev/'
    spec.source                   = { :http=> 'https://packages.nextome.dev/artifactory/nextome-sdk-cocoapods-local/NextomeLocalization/3.2.6-dev-rc05/NextomeLocalization.zip'}
    spec.authors                  = ''
