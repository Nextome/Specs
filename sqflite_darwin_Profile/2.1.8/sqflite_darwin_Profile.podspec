...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local//NextomeMap/2.1.8/Profile/sqflite_darwin_Profile/sqflite_darwin_Profile.zip' }
