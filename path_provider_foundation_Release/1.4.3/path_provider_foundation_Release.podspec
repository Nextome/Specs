...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local/NextomeMap/1.4.3/Release/path_provider_foundation_Release/path_provider_foundation_Release.zip' }
