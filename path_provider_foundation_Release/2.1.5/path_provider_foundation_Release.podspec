...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local//NextomeMap/2.1.5/Release/path_provider_foundation_Release/path_provider_foundation_Release.zip' }
