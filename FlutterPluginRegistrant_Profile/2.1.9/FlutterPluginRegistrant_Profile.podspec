...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local//NextomeMap/2.1.9/Profile/FlutterPluginRegistrant_Profile/FlutterPluginRegistrant_Profile.zip' }
