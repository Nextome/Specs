...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local/NextomeMap/1.4.4/Profile/FlutterPluginRegistrant_Profile/FlutterPluginRegistrant_Profile.zip' }
