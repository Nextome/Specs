...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-sdk-cocoapods-local/PhoenixMapUtils/1.4.3.2/Debug/PhoenixMapUtils_Debug.zip' }
s.ios.deployment_target = '13.2'
s.dependency 'PhoenixSdk',  '2.0.0-rc3'
s.dependency 'NextomeMap_Debug', '1.4.3'
