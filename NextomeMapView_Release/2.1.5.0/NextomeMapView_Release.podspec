...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local//NextomeMapView/2.1.5.0/Release/NextomeMapView_Release.zip' }
s.ios.deployment_target = '13.2'
s.dependency 'NextomeMap_Release', '2.1.5'
