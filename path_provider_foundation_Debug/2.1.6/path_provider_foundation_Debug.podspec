...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local//NextomeMap/2.1.6/Debug/path_provider_foundation_Debug/path_provider_foundation_Debug.zip' }
