...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local/NextomeMap/1.4.3/Debug/path_provider_foundation_Debug/path_provider_foundation_Debug.zip' }
