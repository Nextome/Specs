#
# Be sure to run pod lib lint NextomeLocalizationMapUtils_Debug.podspec to ensure this is a
...
#
Pod::Spec.new do |s|
s.name             = 'NextomeLocalizationMapUtils_Debug'
s.version          = '1.4.4.2'
s.summary          = 'NextomeLocalizationMapUtils_Debug.'
...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-sdk-cocoapods-local/NextomeLocalizationMapUtils/1.4.4.2/Debug/NextomeLocalizationMapUtils_Debug.zip' }
s.ios.deployment_target = '13.2'
s.dependency 'NextomeLocalization',  '3.0.0-rc02'
