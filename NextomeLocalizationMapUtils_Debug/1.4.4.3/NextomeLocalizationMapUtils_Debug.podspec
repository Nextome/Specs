...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-sdk-cocoapods-local/NextomeLocalizationMapUtils/1.4.4.3/Debug/NextomeLocalizationMapUtils_Debug.zip' }
