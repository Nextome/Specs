...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local//NextomeMap/2.1.5/Release/FlutterPluginRegistrant_Release/FlutterPluginRegistrant_Release.zip' }
