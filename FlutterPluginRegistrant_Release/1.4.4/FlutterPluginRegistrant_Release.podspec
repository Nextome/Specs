...
s.source           = { :http => 'https://packages.nextome.dev/artifactory/nextome-map-cocoapods-local/NextomeMap/1.4.4/Release/FlutterPluginRegistrant_Release/FlutterPluginRegistrant_Release.zip' }
